...
const pillars = [
  {
    icon: Eye,
    title: "Our Vision",
    text: "A world where technology and nature coexist — where every device you hold is a step towards a healthier planet, not away from it.",
  },
  {
    icon: Target,
    title: "Our Mission",
    text: "To design and build AI-powered hardware using biodegradable, recycled, and ethically sourced materials — proving that innovation doesn't require compromise.",
  },
  {
    icon: Heart,
    title: "Our Values",
    text: "Transparency in every chip. Sustainability in every circuit. We believe the best technology should leave the smallest footprint.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-lg">
            Aroip was founded on a simple belief: the future of technology must be green. 
            We're a team of engineers, designers, and environmentalists crafting smart devices 
