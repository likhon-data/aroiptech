...
const About = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="About Aroip – Premium Eco-Tech Brand"
        description="Aroip is a premium technology brand proving luxury and sustainability are inseparable. Learn about our mission, values, and limited edition promise."
        canonical="https://aroiptech.lovable.app/about"
      />
      <Navbar />
      ...
      <section className="py-20 px-6 bg-secondary/30">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeUp} className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-sm tracking-[0.3em] uppercase text-muted-foreground decorative-line mb-4">Our Story</span>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>Founded in 2025, Aroip was born from a simple yet radical idea: what if the most advanced technology in the world was also the most responsible?</p>
                <p>We saw an industry drowning in e-waste, built on planned obsolescence and disposable design. We chose a different path — one where every chip, every casing, every component is designed to last and designed to return to the earth when its journey ends.</p>
                <p>As a premium brand, we don't mass-produce. <strong>Every Aroip product is a limited edition</strong>, numbered and authenticated. This isn't just about exclusivity — it's about responsibility. Fewer units means less waste, higher quality, and a deeper connection between you and your device.</p>
              </div>
            </div>
            <div className="relative">
              <div className="glass-card rounded-3xl p-10 text-center">
                <Award className="w-16 h-16 text-primary mx-auto mb-6" />
                <h3 className="text-2xl font-bold text-foreground mb-3" style={{ fontFamily: "var(--font-heading)" }}>Limited Edition Promise</h3>
                <p className="text-muted-foreground leading-relaxed">Every product we launch is produced in limited quantities. Each unit is individually numbered, registered, and comes with a certificate of authenticity and sustainability.</p>
                <div className="mt-6 inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold">
                  <Crown className="w-4 h-4" /> Numbered & Certified
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            <span className="text-sm tracking-[0.3em] uppercase text-muted-foreground decorative-line justify-center mb-4">What Defines Us</span>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div {...fadeUp}>
            ...
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed text-left md:text-center">
              <p>In a world of mass production, we chose scarcity with purpose. Every Aroip product is released in a controlled, limited run — not to create artificial demand, but to ensure every unit meets our exacting standards of quality and sustainability.</p>
              <p>Limited production means we source only the best recycled and biodegradable materials. It means our artisans have time to perfect every detail. It means less waste, fewer carbon emissions, and a product you'll treasure for years.</p>
              <p className="font-semibold text-foreground">When you own an Aroip device, you own something rare — a piece of technology that was made with intention, numbered by hand, and built to outlast trends.</p>
            </div>
          </motion.div>
        </div>
      </section>
